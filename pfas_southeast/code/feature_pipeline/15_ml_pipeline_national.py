...
# ── Paths ─────────────────────────────────────────────────────────────────────
BASE              = Path(__file__).resolve().parent.parent.parent  # repo layout: this file lives in code/feature_pipeline/, data/ is a sibling of code/
PFAS_FEATURES_CSV = BASE / 'data' / 'national_pfas_features_ready.csv'
LI_FEATURES_CSV   = BASE / 'data' / 'national_li_features_ready.csv'
