#!/usr/bin/env python3
"""
Train and save the FINAL PFAS models for the southeast regional arm, using
...
(produced by backward_elim_pfas.py --arm southeast --model ...), same
directory.

Usage:
  python3 train_final_pfas.py --arm southeast --model rf
  python3 train_final_pfas.py --arm southeast --model xgb
"""
import argparse
